...
public class MicrostreamHealthCheck implements HealthCheck {
    ...
    public static class Builder implements io.helidon.common.Builder<MicrostreamHealthCheck> {
        ...
        /**
         * get the current set EmbeddedStorageManager.
         *
        ...
        /**
         * get the current set timeout duration.
         *
         * @return long
         */
        ...
        /**
         * get the current set timeout unit.
         *
         * @return TimeUnit
         */
        ...
        /**
         * get the current configured name of this health check.
         * @return String
         */
        public String name() {
            return name;
